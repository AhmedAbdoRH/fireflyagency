        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm text-gray-400">
              ...
              <li><a href="https://api.whatsapp.com/send?phone=2001552479991" className="hover:text-firefly-green transition-colors">WhatsApp: +20 01552479991</a></li>
              <li><a href="tel:+2001552479991" className="hover:text-firefly-green transition-colors">Phone: +20 01552479991</a></li>
            </ul>
          </div>
