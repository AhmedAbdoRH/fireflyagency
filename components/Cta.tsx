            ...
            <div className="bg-firefly-dark rounded-[2.4rem] py-20 px-6 md:px-16 text-center relative overflow-hidden group">
              ...
              <Reveal delay={400} width="100%">
                <div className="relative z-10 flex flex-col sm:flex-row items-center justify-center gap-4">
                  ...
                  <a 
                    href="mailto:info@firefly-agency.com"
                    className="w-full sm:w-auto px-8 py-4 bg-firefly-dark border border-white/20 text-white font-bold rounded-xl hover:bg-white/10 transition-colors flex items-center justify-center gap-2 text-lg"
                  >
