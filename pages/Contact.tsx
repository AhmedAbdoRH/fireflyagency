                                ...
                                <div className="space-y-8">
                                    ...
                                    <div className="flex items-start gap-6 group">
                                        ...
                                        <div>
                                            ...
                                            <a href="https://wa.me/+2001552479991" target="_blank" rel="noopener noreferrer" className="text-xl text-white font-medium hover:text-green-400 transition-colors">
                                                +20 01552479991
                                            </a>
                                        </div>
                                    </div>
                                    ...
                                    <div className="flex items-start gap-6 group">
                                        ...
                                        <div>
                                            ...
                                            <a href="tel:+2001552479991" className="text-xl text-white font-medium hover:text-firefly-green transition-colors">
                                                +20 01552479991
                                            </a>
                                        </div>
                                    </div>
